"""
Random Survival Forest baseline for EAGLE comparison
"""
...
def main():
    parser = argparse.ArgumentParser(description="RSF baseline for survival prediction")
    ...
    log_file = Path(args.output_dir) / f"rsf_{args.dataset}_{timestamp}.log"
    ...
    logging.info(f"Starting RSF baseline for {args.dataset}")
    ...
    # Save results
    results_file = Path(args.output_dir) / f"rsf_{args.dataset}_{timestamp}_results.json"
